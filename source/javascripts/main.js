...
CHAKRA.slider = function(){
	$.supersized({
		...
		slides 					:  	[			// Slideshow Images
											{image : 'assets/images/slider-images/image01.jpg', title : '<div class="slide-content"></div>', thumb : '', url : ''},
											{image : 'assets/images/slider-images/image02.jpg', title : '<div class="slide-content"></div>', thumb : '', url : ''},
											{image : 'assets/images/slider-images/image03.jpg', title : '<div class="slide-content"></div>', thumb : '', url : ''},
											{image : 'assets/images/slider-images/image04.jpg', title : '<div class="slide-content"></div>', thumb : '', url : ''}  
									],
...
CHAKRA.tweetFeed = function(){
    ...
    $("#ticker").tweet({
          username: "OspreyDawn", // Change this with YOUR ID
          page: 1,
          avatar_size: 0,
          count: 10,
		  template: "{text}{time}",
...
$(document).ready(function(){
	...
	Modernizr.load([
	{
		...
		nope: 'javascripts/libs/placeholder.js', 
		complete : function() {
